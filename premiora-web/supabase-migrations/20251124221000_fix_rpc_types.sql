-- Migration: Fix get_feed_posts and get_post_details RPC types
-- Description: Adds explicit type casts to ensure query result matches RETURNS TABLE definition.
